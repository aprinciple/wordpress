<?php get_header(); ?>
<div class="page-drainage-system__promo-post promo-post">
  <div class="promo-post__container container">
    ...
    <div class="promo-post__item promo-post__item--slider page-drainage-system__slider">
...
<div class="page-drainage-system__container container">
  <div class="page-drainage-system__menu-tab menu-tab">
    <div class="menu-tab__item menu-tab__item--nav menu-tab__nav">
      <?php wp_nav_menu( ['theme_location' => 'drainage-menu'] ) ?>
    </div>
...
<div class="page-drainage-system__make-request">
