<?php get_header(); ?>
<div class="page-landscaping__promo-post promo-post">
  <div class="promo-post__container container">
    ...
    <div class="promo-post__item promo-post__item--slider page-landscaping__slider">
...
<div class="page-landscaping__container container">
  <div class="page-landscaping__menu-tab menu-tab">
    <div class="menu-tab__item menu-tab__item--nav menu-tab__nav">
      <?php wp_nav_menu( ['theme_location' => 'landscaping-menu'] ) ?>
    </div>
...
<div class="page-landscaping__make-request">
