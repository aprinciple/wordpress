<?php get_header(); ?>
<div class="page-fence-installation__promo-post promo-post">
  <div class="promo-post__container container">
    ...
    <div class="promo-post__item promo-post__item--slider page-fence-installation__slider">
...
<div class="page-fence-installation__container container">
  <div class="page-fence-installation__menu-tab menu-tab">
    <div class="menu-tab__item menu-tab__item--nav menu-tab__nav">
      <?php wp_nav_menu( ['theme_location' => 'fence-installation'] ) ?>
    </div>
...
<div class="page-fence-installation__make-request">
