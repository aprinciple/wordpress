<?php get_header(); ?>
<div class="page-thuja__promo-post promo-post">
  <div class="promo-post__container container">
    ...
    <div class="promo-post__item promo-post__item--slider page-thuja__slider">
...
<div class="page-thuja__container container">
  <div class="page-thuja__menu-tab menu-tab">
    <div class="menu-tab__item menu-tab__item--nav menu-tab__nav">
      <?php wp_nav_menu( ['theme_location' => 'thuja-menu'] ) ?>
    </div>
...
<div class="page-thuja__make-request">
