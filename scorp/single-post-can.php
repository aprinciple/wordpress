<?php get_header('single-post-can'); ?>
<main class="page-project-can__main">
    <div class="container page-project-can__container">
      <?php the_post(); ?>
        ...
        <div class="project__wrapper">
          ...
          <div class="project__item">
            ...
            <div class="project__buttons">
              <a class="button project__button project__button--gold" href="#">Заказать проект</a>
  ...
  <?php get_footer('single-post-can'); ?>