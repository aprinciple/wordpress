...
<body <?php body_class( 'page-project-want' ); ?>>
  <header class="header">
      ...
      <div class="header__breadcrumbs">
        <nav class="breadcrumbs">
          <?php 
            echo strip_tags(
              wp_nav_menu([
                'theme_location'  => 'breadcrumbs_single_post_want',
                'container'       => false,
                'echo'            => false,
                'items_wrap'      => '%3$s',
                'depth'           => 0,
          ...
          ?>
          <a href="<?php the_permalink(); ?>" class="breadcrumbs__link breadcrumbs__link--active">Проект</a>
        </nav>
      </div>
