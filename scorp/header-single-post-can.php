...
<body <?php body_class( 'page-project-can' ); ?>>
  <header class="header">
    <div class="header__container container">
      ...
      <div class="header__breadcrumbs">
        <nav class="breadcrumbs">
          <?php 
            echo strip_tags(
              wp_nav_menu([
                'theme_location'  => 'breadcrumbs_single_post_can',
                'container'       => false,
                'echo'            => false,
                'items_wrap'      => '%3$s',
                'depth'           => 0,
          ...
          ?>
          <a href="<?php the_permalink(); ?>" class="breadcrumbs__link breadcrumbs__link--active">Заказать проект</a>
        </nav>
      </div>
      ...
      <div class="header__search">
        ...
        <a class="button header__search-button" href="<?php echo home_url('add-project'); ?>">Добавить свой проект</a>
      </div>
    </div>
  </header>