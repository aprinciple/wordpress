  ...
  ob_start(); ?>
    <form class="form form--post form-questions" action="" method="POST">
      ...
      <label class="form__label form-questions__label">
        <input class="form__input form-questions__input" name="user_name" type="text" placeholder="Ваше имя*" required>
      </label>
      <label class="form__label form-questions__label">
        <input class="form__input form-questions__input" name="user_phone" type="tel" placeholder="Ваш номер телефона*" required>
      </label>
