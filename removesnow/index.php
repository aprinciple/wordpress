...
<section id="services" class="services">
  ...
  <div class="services__container container">
    <div class="services__items">
      ...
      <?php 
        $image = get_field('services_image-1');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
          <h3 class="services__item-title">В коттедже</h3>
          <a class="services__item-link button" href="#">Узнать стоимость</a>
        </div>
      </div>
      <div class="services__item">
      <?php 
        $image = get_field('services_image-2');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
          <h3 class="services__item-title">На складе</h3>
          <a class="services__item-link button" href="#">Узнать стоимость</a>
        </div>
      </div>
      <div class="services__item">
      <?php 
        $image = get_field('services_image-3');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
          <h3 class="services__item-title">На крыше</h3>
          <a class="services__item-link button" href="#">Узнать стоимость</a>
        </div>
      </div>
      <div class="services__item">
      <?php 
        $image = get_field('services_image-4');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
          <h3 class="services__item-title">Где</h3>
          <a class="services__item-link button" href="#">Узнать стоимость</a>
        </div>
      </div>
      <div class="services__item">
      <?php 
        $image = get_field('services_image-5');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
      ...
      <div class="services__item">
      <?php 
        $image = get_field('services_image-6');
        if( !empty( $image ) ): ?>
          <img class="services__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
        <div class="services__item-text">
          <h3 class="services__item-title">Коммерческие помещения</h3>
          <a class="services__item-link button" href="#">Узнать стоимость</a>
        </div>
      </div>
    </div>
  ...
  <div class="our-works__container container">
    <div class="our-works__items">
      ...
      <?php 
        ...
        if( !empty( $image ) ): ?>
          <img class="our-works__item-image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
      <?php endif; ?>
      </div>
      <div class="our-works__item">
      <?php 
...
<section class="export-cost">
  ...
  <div class="export-cost__items">
    <div class="export-cost__item export-cost__item--image">
    </div>
    <div class="export-cost__item export-cost__item--form">
      <?php echo do_shortcode( '[form_export]' ) ?>
    </div>
  </div>
</section>
    ...
    <div class="slider-feedback">
      <div class="slider-feedback__items">
        ...
        <?php 
          ...
          if( !empty( $image ) ): ?>
            <img class="slider-feedback__image" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
        <?php endif; ?>
