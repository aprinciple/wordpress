...
<body <?php body_class('page-design'); ?>>
  <header class="header header-post page-design__header-post">
    ...
    <div class="header__bar page-design__header-post-bar">
      <div class="header__bar-container container">
        <div class="header__bar-item">
          <img class="header__bar-logo" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-bar-white.svg" alt="Consul Staff">
        </div>
        <div class="header__bar-item header__bar-aside">
          <a class="header__bar-item-link page-design__header-post-bar-link" href="mailto:<?php the_field('main_contacts_mail', $frontpage_id); ?>">
          <?php the_field('main_contacts_mail', $frontpage_id); ?>
        </a>
          <a class="header__bar-item-link page-design__header-post-bar-link" href="tel:<?php the_field('main_contacts_phone', $frontpage_id); ?>">
