...
<body <?php body_class('page-post-news'); ?>>
    ...
    <div class="header__bar">
      <div class="header__bar-container container">
        ...
        <div class="header__bar-item header__bar-aside">
          <a class="header__bar-item-link" href="mailto:<?php the_field('main_contacts_mail', $frontpage_id); ?>">
          <?php the_field('main_contacts_mail', $frontpage_id); ?>
          </a>
          <a class="header__bar-item-link" href="tel:<?php the_field('main_contacts_phone', $frontpage_id); ?>">
