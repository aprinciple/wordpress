<?php get_header(); ?>
      ...
      <div class="home-services__item home-services__item--list">
        <ul class="home-services__list">
          <li class="home-services__list-item">
            <a class="home-services__list-link" href="<?php echo home_url(); ?>/services" data-image="<?php echo get_template_directory_uri(); ?>/assets/img/bg-home-services.jpg">
            <?php the_field('home_services_menu_item-1'); ?>
            </a>
          </li>
          <li class="home-services__list-item">
            <a class="home-services__list-link" href="<?php echo home_url(); ?>/services" data-image="<?php echo get_template_directory_uri(); ?>/assets/img/bg-home-services-2.jpg">
            <?php the_field('home_services_menu_item-2'); ?>
            </a>
          </li>
          <li class="home-services__list-item">
            <a class="home-services__list-link" href="<?php echo home_url(); ?>/services" data-image="<?php echo get_template_directory_uri(); ?>/assets/img/bg-home-services-3.jpg">
            <?php the_field('home_services_menu_item-3'); ?>
            </a>
          </li>
          <li class="home-services__list-item">
            <a class="home-services__list-link" href="<?php echo home_url(); ?>/services" data-image="<?php echo get_template_directory_uri(); ?>/assets/img/bg-home-services-4.jpg">
            <?php the_field('home_services_menu_item-4'); ?>
            </a>
          </li>
          <li class="home-services__list-item">
            <a class="home-services__list-link" href="<?php echo home_url(); ?>/services" data-image="<?php echo get_template_directory_uri(); ?>/assets/img/bg-home-services-5.jpg">
  ...
  <section class="page-home__news-advert news-advert">
      ...
      <?php
        if( $loop->have_posts() ) {
          while( $loop->have_posts() ) {
            $loop->the_post();
            ?>
            <article class="card news-advert__card">
    ...
    <a class="news-advert__button button button-arrow" href="/news">
  ...
  <section class="home-contacts">
    <div class="home-contacts__container container">
      <div class="home-contacts__item home-contacts__item--contacts contacts">
        <h4 class="home-contacts__title contacts__title"><?php the_field('home_contacts_title'); ?></h4>
        <h5 class="home-contacts__subtitle contacts__subtitle">ConsulStaff s.r.l.</h5>
        <div class="contacts__item">
          <h6 class="contacts__item-title"><?php the_field('home_contacts_italia_title'); ?></h6>
          <?php the_field('home_contacts_italia_text'); ?>
        </div>
        <div class="contacts__item">
          <h6 class="contacts__item-title"><?php the_field('home_contacts_russia_title'); ?></h6>
          <?php the_field('home_contacts_russia_text'); ?>
        </div>
        <a class="contacts__item contacts__email" href="mailto:<?php the_field('home_contacts_mail'); ?>">
          <?php the_field('home_contacts_mail'); ?>
        </a>
        <p class="contacts__item contacts__piva">
          <?php the_field('home_contacts_piva'); ?>
        </p>
      </div>
      <div class="home-contacts__item home-contacts__item--form">
        <div class="home-contacts__form">
          <?php echo do_shortcode( '[form_home_contact]' ) ?>
        </div>
      </div>
    </div>
  </section>
