...
//echo "function_exists('is_mobile')" . function_exists('is_mobile');
...
if(function_exists('is_mobile') and is_mobile()){
	...
	function my_mobthemeinit(){
		...
		// wp_enqueue_script('jquery mobile investments js', $or_template_directory.'/mobile/js/scripts-investment.js', false, $vers);
		// wp_enqueue_script('jquery mobile min2 js', $or_template_directory.'/mobile/js/jquery.animateNumber.js', false, $vers);
		// wp_enqueue_script('jquery mobile min3 js', $or_template_directory.'/mobile/js/jquery.mask.min.js', false, $vers);
	}
} 
