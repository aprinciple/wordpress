...
global $premiumbox;
	...
	add_submenu_page("pn_themeconfig", __('Color scheme','pntheme'), __('Color scheme','pntheme'), 'administrator', "pn_theme_color_scheme", array($premiumbox, 'admin_temp'));
}
...
global $premiumbox;
	...
	$options['color_scheme'] = array(
		...
		'default' => $premiumbox->get_option('color_scheme'),
		'name' => 'color_scheme',
		'work' => 'input',
	);
...
global $wpdb, $premiumbox;	
	...
	$premiumbox->update_option('color_scheme','', $color_scheme);			
...
global $premiumbox;
	...
	$classes[] = $premiumbox->get_option('color_scheme');
